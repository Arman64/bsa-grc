...
export async function POST(request: NextRequest) {
 try {
  ...
  return NextResponse.json({ success: true, message: "Portofolio berhasil ditambah ke", data: newItem }, { status: 201 });
 } catch (error) {
  console.error(error);
...
export async function PUT(request: NextRequest) {
 try {
  ...
  return NextResponse.json({ success: true, message: "Portofolio berhasil diupdate di", data: updated });
 } catch (error) {
  console.error(error);
...
export async function DELETE(request: NextRequest) {
 try {
  ...
  return NextResponse.json({ success: true, message: "Portofolio berhasil dihapus dari" });
 } catch (error) {
  console.error(error);
