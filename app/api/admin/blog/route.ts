...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ success: true, message: "Artikel berhasil ditambah ke Neon DB", data: newBlog }, { status: 201 });
  } catch (error) {
    console.error(error);
...
export async function PUT(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ success: true, message: "Artikel berhasil diupdate di Neon DB", data: updated });
  } catch (error) {
    console.error(error);
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ success: true, message: "Artikel berhasil dihapus dari Neon DB" });
  } catch (error) {
    console.error(error);
