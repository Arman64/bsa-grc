...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description: `Galeri portofolio ${COMPANY_INFO.projectsCompleted}+ proyek BSA GRC: kubah masjid, menara, krawangan GRC & mihrab ACP di seluruh Indonesia. Foto resolusi tinggi dengan detail info ikonografi. Data dari Neon DB.`,
    ...
    <>
      <section className="py-16 lg:py-20 bg-gradient-to-br from-white to-gold-50/30 border-b">
        <div className="container mx-auto px-4 lg:px-8">
          <SectionHeader
            badge={`${projects.length || COMPANY_INFO.projectsCompleted}+ Proyek - Neon DB`}
            badgeVariant="maroon"
            title={
              <>
            ...
            description={`Galeri lengkap dokumentasi kubah, menara, krawangan & mihrab ACP dari database Neon. Setiap kartu ada detail lokasi, tahun, diameter, material - klik untuk detail proyek.`}
          />
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          {projects.length === 0 ? (
            <div className="max-w-2xl mx-auto text-center py-16 bg-white rounded-2xl border-2 border-dashed">
              ...
              <h3 className="font-bold text-lg">Belum Ada Data Portofolio di Neon DB</h3>
              <p className="text-sm text-muted-foreground mt-2 max-w-md mx-auto">
                Database Neon kosong. Jalankan seed di local dengan DATABASE_URL Neon: <code className="bg-muted px-2 py-1 rounded">npm run db:push && npm run db:seed</code> untuk import 6 proyek contoh. Atau tambah manual via <code className="bg-muted px-1 rounded">/admin/portfolio</code>.
              </p>
