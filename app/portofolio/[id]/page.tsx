                ...
                <div className="bg-maroon-900 text-white rounded-2xl p-6 relative overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-[11px] text-white/50 mt-3 flex items-center gap-2">
                      <Clock className="w-3 h-3" /> Respon &lt;5 Menit • Senin-Sabtu 08:00-17:00 • Neon DB
                    </p>
                  </div>
                </div>
            ...
            <div className="container mx-auto px-4 lg:px-8">
              <div className="max-w-6xl mx-auto">
                <SectionHeader
                  ...
                  description={`Proyek lain dengan kategori ${item.category} dari BSA GRC - data dari Neon DB`}
                  align="left"
                />
                <div className="mt-8">
