      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">FAQ untuk homepage & landing page ads. Kategori bisa Umum atau per layanan (kubah-grc, menara, dll). Data Neon DB.</p>
          </div>
