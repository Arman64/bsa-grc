      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-2">Kelola gambar, teks, dan portofolio pekerjaan dengan mudah. Semua perubahan langsung tampil di website. {process.env.DATABASE_URL ? "DB Neon Aktif ✅" : "Mode File JSON (set DATABASE_URL untuk Neon)"}</p>
          </div>
            ...
            <div className="bg-gradient-to-br from-maroon-700 to-maroon-900 text-white rounded-2xl p-6 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="mt-4 bg-white/10 rounded-xl p-3 border border-white/10">
                  ...
                  <p className="text-xs text-white/70 mt-1">{process.env.DATABASE_URL ? "Neon Postgres aktif - data persist di Vercel ✅" : "Mode file JSON - set DATABASE_URL di Vercel untuk Neon persist"}</p>
                </div>
              </div>
            </div>
