...
/** SEC: safely serialize an object for inlining into a <script type="application/ld+json"> tag.
 * JSON.stringify() does not escape "</", so a user-controlled string containing "</script>"
 * can break out of the tag and inject HTML (stored XSS). Escaping <, >, & and line separators
 * neutralizes this while remaining valid JSON-LD. */
