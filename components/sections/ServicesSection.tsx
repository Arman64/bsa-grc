...
export default async function ServicesSection() {
 ...
 return (
  ...
  <div className="container mx-auto px-4 lg:px-8 text-center">
   ...
   description="Database layanan kosong. Silakan tambah layanan melalui halaman admin."
   />
  </div>
  </section>
 );
 ...
 <section className="cv-auto py-16 lg:py-24 bg-white relative overflow-hidden">
  ...
  <SectionHeader
   ...
   description="Fokus produksi GRC dengan detil presisi dari database, harga terjangkau, pelayanan nasional. Termasuk Mihrab ACP premium."
  />
  ...
  <div className="mt-12 lg:mt-16 grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
   ...
   <div className="relative">
    ...
    Gratis jasa Desain, Konsultasi & Survey lokasi Kubah Masjid, Menara, Ornamen GRC di seluruh Indonesia.
    </p>
   ...
   <div className="relative space-y-3">
    ...
    <p className="text-[11px] text-white/60 text-center">Respon &lt; 5 Menit • Senin - Sabtu 08:00-17:00 WIB</p>
   </div>
   </div>
  </div>
  </div>
