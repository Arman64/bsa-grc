  ...
  return (
    <section className="py-16 lg:py-24 bg-white relative overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8">
        <SectionHeader
          badge={`Testimoni Klien - ${testimonials.length} Ulasan - Neon DB`}
          badgeVariant="gold"
          title={
            <>
          ...
          description="Testimoni nyata dari panitia pembangunan masjid di seluruh Indonesia yang telah menggunakan jasa BSA GRC - data dari Neon DB."
        />
        ...
        <div className="mt-10 flex flex-wrap justify-center items-center gap-6">
          <div className="flex items-center gap-3 bg-gold-50 border border-gold-200 rounded-full px-5 py-2.5">
            ...
            <span className="text-xs text-muted-foreground">({testimonials.length} ulasan) - Neon DB</span>
          </div>
          <span className="text-xs text-muted-foreground bg-muted px-3 py-1.5 rounded-full border">
            Data dari Neon DB, kelola di /admin/testimonials
          </span>
        </div>
