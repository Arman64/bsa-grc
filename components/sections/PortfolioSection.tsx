...
export default async function PortfolioSection() {
 ...
 <section className="py-16 lg:py-24 bg-muted/40 relative overflow-hidden border-y border-gold-100/50">
  ...
  <SectionHeader
   badge={`${COMPANY_INFO.projectsCompleted}+ Proyek Selesai`}
   badgeVariant="maroon"
   title={
   <>
   ...
   description={`Dokumentasi pengerjaan kubah, menara, krawangan & mihrab ACP presisi dari. Dari ${COMPANY_INFO.address.regency} untuk 34 provinsi.`}
  />
  ...
  <div className="mt-12 lg:mt-16">
   ...
   <div className="text-center py-12 bg-white rounded-2xl border-2 border-dashed">
    ...
    <p className="text-sm text-muted-foreground mt-1">Silakan tambah data melalui halaman admin /admin/portfolio</p>
   </div>
   ) : (
  ...
  <div className="mt-12 bg-white rounded-2xl border border-gold-100 shadow-soft p-4 lg:p-5">
   ...
   <div className="flex items-center gap-6">
    ...
    {COMPANY_INFO.projectsCompleted}+ Klien Masjid
    </span>
   </div>
