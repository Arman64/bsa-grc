...
export default async function AboutSection() {
  ...
  const achievements = [
    { icon: Factory, label: "Pabrik Sendiri", value: company?.address?.regency || "Trenggalek", desc: "Produksi langsung - Neon DB" },
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="relative order-2 lg:order-1">
            <div className="relative h-[420px] lg:h-[520px] rounded-[2rem] overflow-hidden bg-muted border shadow-large">
              <Image
                ...
                alt="Profil BSA GRC - Pabrik Trenggalek - Neon DB"
                fill
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-xl rounded-2xl p-4 border border-gold-200 shadow-medium">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-bold text-sm text-foreground">Pabrik & Workshop BSA GRC - Neon DB</p>
                    ...
                    <p className="text-[11px] text-maroon-700 font-semibold mt-2 bg-maroon-50 px-2 py-1 rounded-full border border-maroon-100 inline-flex">
                      ✓ Lokasi strategis, akses mudah, pengiriman nasional - Data dari Neon DB
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="order-1 lg:order-2 space-y-6">
            <SectionHeader
              badge="Profil Perusahaan - Neon DB"
              badgeVariant="maroon"
              title={
                <>
              ...
              description={`${company?.name || "BSA GRC"} bergerak khusus industri pembuatan & pemasangan produk GRC (Glassfibre Reinforced Cement) yang sudah berpengalaman lebih dari ${company?.yearsExperience || 10} tahun dan dapat diandalkan dibidangnya. Data dari Neon DB.`}
              align="left"
            ...
            <div className="space-y-4 pt-2">
              <h3 className="font-bold text-foreground">Kenapa Pilih BSA GRC? (Neon DB)</h3>
